...
public class ReviewController {
	...
	public String reviewWritePOST(HttpServletRequest req, ReviewVO Rvo, @RequestParam(value = "fileImg") MultipartFile rImg) throws Exception {
	...
	public void reviewUpdateGET(@RequestParam("odNum") int odNum, @RequestParam("pNum") int pNum, Model model) throws Exception {
		...
		ReviewVO Rvo = rService.selectOdNumReview(odNum);
	...
	// POST 리뷰 수정하기
	@RequestMapping(value = "/review/review_update", method = RequestMethod.POST)
	public String reviewUpdatePOST(HttpServletRequest req, ReviewVO Rvo, @RequestParam(value = "fileImg") MultipartFile rImg)	throws Exception {
