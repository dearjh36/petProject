 ...
 * Generated at: 2022-12-14 01:38:56 UTC
...
public final class contract_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/WEB-INF/views/member/../include/header.jsp", Long.valueOf(1670948612335L));
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("	<p></p>\r\n");
      out.write("	<form id=\"join\" action=\"/member/join\" method=\"get\" name=\"formm\">\r\n");
      out.write("		언제나 새로운 즐거움이 가득한  웰컴펫의 회원가입 페이지 입니다. <br>\r\n");
      out.write("		웰컴펫의 회원가입은 무료이며, <br>\r\n");
      out.write("		회원님의 개인신상에 관한 정보는 ‘정보통신망이용촉진 및 정보보호등에관한법률’에 의해 <br>\r\n");
      out.write("		회원님의 동의없이 제 3자에게 제공되지 않으며, 철저히 보호되고 있사오니 안심하고 이용하시기 바랍니다.<br><br>\r\n");
      out.write("		\r\n");
      out.write("		<textarea rows=\"15\" cols=\"100\" id=\"con_area\">\r\n");
      out.write("       제 1 장 총 칙\r\n");
      out.write("\r\n");
      out.write("제 1 조 (목적) \r\n");
      out.write("이 이용약관(이하 '약관')은 주식회사 웰컴펫(이하 회사라 합니다)와 이용 고객(이하 '회원')간에 회사가 제공하는 jjang0u.com서비스의 가입조건 및 이용에 관한 다음의 제반 사항과 기타 기본적인 사항을 구체적으로 규정함을 목적으로 합니다.\r\n");
      out.write("\r\n");
      out.write("제 2 조 (이용약관의 효력 및 변경) \r\n");
      out.write("(1) 이 약관은 웰컴펫 웹사이트(www.웰컴펫.com 이하 '웰컴펫웹')에서 온라인으로 공시함으로써 효력을 발생하며, 합리적인 사유가 발생할 경우 관련법령에 위배되지 않는 범위 안에서 개정될 수 있습니다. 개정된 약관은 온라인에서 공지함으로써 효력을 발휘하며, 이용자의 권리 또는 의무 등 중요한 규정의 개정은 사전에 공지합니다.\r\n");
      ...
      out.write("(1) \"이용자\" 또는”회원”이란 \"웰컴펫\"에 접속하여 본 약관에 따라 \"웰컴펫\"에 가입하여, 이용 고객의 식별과 이용고객의 서비스 이용을 위하여 이용고객 본인이 직접 선정하고 회사가 부여하는 문자와 숫자 조합인 ‘이용자번호(ID)’와 그에 따라 일치된 이용고객임을 확인하기 위하여 이용고객 본인이 선정한 ‘비밀번호’를 이용하여 \"웰컴펫\"이 제공하는 서비스를 받는 자를 말합니다.\r\n");
      ...
      out.write("(1) 이용계약은 이용고객의 본 이용약관 내용에 대한 동의와 이용신청에 대하여 회사의 이용승낙으로 성립하여 이용약관에 대한 동의는 이용신청 당시 해당 웰컴펫 웹의 '동의함' 버튼을 누름으로써 의사표시를 합니다.\r\n");
      out.write("\r\n");
      ...
      out.write("회사는 관련법령이 정하는 바에 따라서 이용자 등록정보를 포함한 이용자의 개인정보를 보호하기 위하여 노력합니다. 이용자의 개인정보보호에 관해서는 관련법령 및 \"웰컴펫\"이 정하는 \"개인정보보호정책\"에 정한 바에 의합니다.\r\n");
      out.write("\r\n");
      ...
      out.write("ㄱ. 가입신청자가 본 약관 의거하여 이전에 회원자격을 상실한 적이 있는 경우. 상실 후 1개월 경과 하지 않은  자로서 \"웰컴펫\"의 회원재가입 승낙을 얻으려 하는 경우\r\n");
      out.write("ㄴ. 등록 내용에 허위, 기재누락, 오기가 있는 경우 \r\n");
      out.write("ㄷ. 사회의 안녕과 질서, 미풍양속을 저해할 목적으로 신청한 경우\r\n");
      out.write("ㄹ. 부정한 용도로 본 서비스를 이용하고자 하는 경우 \r\n");
      out.write("ㅁ. 웰컴펫의 정책과 위배 되어지는 행위를 반복적으로 자행하여 회원 자격 상실을 한 적이 있는 경우\r\n");
      ...
      out.write("(3) ‘웰컴펫’의 이용자ID는 이용자 본인의 동의하에 ‘웰컴펫’이 운영하는 자사 사이트의 회원ID와 연결될 수 있습니다.\r\n");
      ...
      out.write("(1) 서비스 이용은 회사의 업무상 또는 기술상 특별한 지장이 없는 한 연중무휴, 1일 24시간 운영을 원칙으로 합니다. 단, 회사는 시스템 정기점검, 증설 및 교체를 위해 회사가 정한 날이나 시간에 서비스를 일시 중단할 수 있으며, 예정되어 있는 작업으로 인한 서비스 일시 중단은 웰컴펫 웹을 통해 사전에 공지합니다.\r\n");
      ...
      out.write("회원이 이용계약을 해지하고자 하는 때에는 회원 본인이 웰컴펫 웹 내의 [도움말] 메뉴를 이용해 가입해지를 해야 합니다. \r\n");
      out.write("\r\n");
      ...
      out.write("(14) 회사는 회원이 웰컴펫을 이용함으로써 회원 본인 또는 제3자에게 직/간접적으로 영향을 미치게 되는 모든 피해와 법적 문제에 대하여 책임을 지지 않습니다.\r\n");
      out.write("\r\n");
      ...
      out.write("			<label><input type=\"radio\" name=\"okon1\"> 동의함</label> &nbsp; &nbsp; &nbsp; \r\n");
      out.write("			<label><input type=\"radio\" name=\"okon1\" checked> 동의안함</label>\r\n");
      out.write("		</div>\r\n");
      out.write("		<input class=\"nextBtn\" type=\"button\" value=\"다음단계\" onclick=\"go_next()\">\r\n");
      out.write("	</form>\r\n");
      out.write("</article>\r\n");
      out.write("\r\n");
      out.write("<link href=\"/resources/css/mypet.css\" rel=\"stylesheet\">\r\n");
  ...
  private boolean _jspx_meth_c_005fwhen_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fchoose_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/member/../include/header.jsp(19,6) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
